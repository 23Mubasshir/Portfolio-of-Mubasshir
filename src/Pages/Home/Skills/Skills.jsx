...
const Skills = () => {
    ...
    return (
        <div id="skills" className=' pt-52 lg:pt-80'>
            <h1 className='mb-8 sm:leading-[50px] text-left uppercase header-text text-[30px] xs:text-[40px] md:text-[60px] lg:text-[120px]'>Technologies <span className=' sm:ps-2 text-[20px] xs:text-[20px] lg:text-[40px]' >That I use.</span></h1>
            <div className=' '>
